...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested function can access the internal variable because it's with in the lexicalmscope of nestedFunction.  
...
const zooAnimals = [
  ...
  */
  ...
  console.log('.map:', lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopulationArray = array.filter(function(item){
  ...
  */
  ...
  function USApop(array){
    const totalPopulation = array.reduce((acc, item) => {return acc + item.population;},0);
...
console.log('Callbacks:', consume(2, 2, add)); // 4
console.log('Callbacks:', consume(10, 16, multiply)); // 160
console.log('Callbacks:', consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log('Topic 3:Prototypes', cuboid.volume()); // 100
console.log('Topic 3:Prototypes', cuboid.surfaceArea()); // 130
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
console.log('Topic 4:Classes', cuboidTwo.volume()); // 100
console.log('Topic 4:Classes', cuboidTwo.surfaceArea()); // 130
